...
public class StreamingAnalytics {
        ...
        public static void main(String[] args) {
                ...
                try {
                        ...
                        KStream<String, SalesOrder> orderObjects = ordersInput.mapValues(
                                        new ValueMapper<String, SalesOrder>() {
                                                ...
                                                public SalesOrder apply(String inputJson) {
                                                        ...
                                                        try {
                                                                SalesOrder order = mapper.readValue(
                                                                                inputJson,
                                                                                SalesOrder.class);
                                                                return order;
                                                        } catch (Exception e) {
                        ...
                        orderObjects.peek(
                                        (key, value) -> System.out.println("Received Order : " + value));
                        ...
                        Aggregator<String, SalesOrder, OrderAggregator> orderAdder = (key, value,
                                        aggregate) -> aggregate.add(value.getPrice()
                                                        * value.getQuantity());
