...
public class StreamingThresholdsAndAlerts {
        ...
        public static void main(String[] args) {
                ...
                try {
                                        ...
                                        .mapValues(
                                                        new ValueMapper<Alert, String>() {
                                                                ...
                                                                public String apply(Alert alert) {
                                                                        String csvStr = "\"" + alert.getTimestamp()
                                                                                        + "\"," +
                                                                                        "\"" + alert.getCode() + "\"," +
                                                                                        "\"" + alert.getMesg() + "\"";
                        ...
                        KTable<Windowed<String>, Long> codeCounts = alertObject.groupBy( // Group by Code
                        ...
                        codeCounts
                                        ...
                                        .peek((key, value) -> System.out
                                                        .println("Summary record :" + key + " = " + value))
                                        ...
                                        .map( // Convert key and value to String for publishing
                                                        new KeyValueMapper<Windowed<String>, Long, KeyValue<String, String>>() {
                                                                ...
                                                                public KeyValue<String, String> apply(
                                                                                Windowed<String> key, Long value) {
